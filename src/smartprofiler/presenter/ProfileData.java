...
public class ProfileData implements Parcelable{
	...
	/**
	 * @return the profile status as int
	 */
	...
	/**
	 * @return the Profile wifi status as int
	 */
	...
	/**
	 * @return the Profile sound status as int.
	 */
	...
	/**
	 * @return the Profile mobile data status as int.
	 */
	...
	/**
	 * @return the Profile's vibration status as int.
	 */
